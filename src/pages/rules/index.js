...
const Rules = () => {
  return (
    <div>
        ...
        <div className='subtitle-content'>
          <p>
            1 - このサーバーの配信や動画の撮影を希望する方は、 <span className='green'>⁠#┣ストリーマー申請（畳公式Discord）</span> について 規約をよく確認の上、ストリーマー申請フォームから申請をしてください。<br />
            2 - 当サーバーのコンテンツを配信した場合における切り抜きは編集及び当サーバーのSNS（YoutubeやTwitter、Discord） にアップロードする場合がございます。ご承知おきください。<br />
            3 - ただし畳サーバーや特定個人を攻撃したり過剰に非難するような内容はお控えください。<br />
            4 - 配信に他プレイヤーの声を乗せたい場合は🎦マークがついたチャンネルを使用してください。
          </p>
        </div>
